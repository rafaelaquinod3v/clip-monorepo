...
@Service
internal class TranslationService(private val allLexiconsRepository: LexiconRepository) {

  fun translate(sourceEntry: LexicalEntry, targetLanguage: LexiconId): List<LexicalEntry> {
